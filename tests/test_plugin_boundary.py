...
FRAMEWORK = {
    "agent_cli", "agent_client", "agent_coverage", "agent_doctor", "dependency_health", "agent_email", "caller", "agent_gdoc", "gdoc_email_blocks", "review_receipt", "agent_health", "agent_web", "canopy_web",
