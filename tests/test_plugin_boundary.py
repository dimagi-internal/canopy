...
FRAMEWORK = {
    "agent_cli", "agent_client", "agent_coverage", "agent_doctor", "dependency_health", "agent_email", "agent_gdoc", "review_receipt", "agent_factory", "agent_health", "agent_web", "canopy_web",
    "inbox_filters",
